...
Captured after the v0.41.0 statistics work. These are *sensible follow-ups that
the data now makes possible* — not committed scope. Ordered by value/effort.
Reference data: a ~37-day Rheine dataset (busy NW-Europe corridor).

## Tier 1 — high value, modest effort

### 1. One-click "Apply recommended defaults"
...
### 2. Capture-yield / precision metric (needs arms × outcomes)
...
### 4. Per-site elevation floor, applied not just suggested
...
### 5. Directional corridor learning (the OW/NS insight)
